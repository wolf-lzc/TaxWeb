...
public class TaxOrgInfo {
    ...
    public boolean comp(TaxOrgInfo info)throws Exception{
        if (info == null)
            return false;

        if (!info.taxCode.equals(this.taxCode))
            return false;
        ...
        if (!info.taxOrg.equals(this.taxOrg))
            return  false;

        if (!info.regtype.equals(this.regtype))
            return  false;

        if (!info.industry.equals(this.industry))
            return false;

        if (!info.tel.equals(this.tel))
            return false;

        if (!info.legalPerson.equals(this.legalPerson))
            return false;

        if (!info.mOrg.equals(this.mOrg))
            return false;

        if (!info.cOrg.equals(this.cOrg))
            return false;

        if (!info.chargeCode.equals(this.chargeCode))
            return  false;

        if (!info.mobile.equals(this.mobile))
            return false;
    ...
    public boolean equals(Object that) {
        ...
        TaxOrgInfo other = (TaxOrgInfo) that;
